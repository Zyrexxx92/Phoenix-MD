    ...
    switch (inputCMD) {
      ...
      case "sticker":
        if (/image/.test(mime)) {
          ...
          Phoenix.sendMessage(m.from, { sticker: stickerBuffer }, { quoted: m });
          ...
          Phoenix.sendMessage(m.from, { sticker: stickerBuffer2 }, { quoted: m });
        } else {
          await doReact("❌");
          m.reply(
      ...
      case "stickermeme":
        if (/image/.test(mime)) {
          ...
          await doReact("📮");
          media = await Phoenix.downloadAndSaveMediaMessage(quoted);
